...
package com.jfoenix.demo.components;
...
public class DatePickerDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        stylesheets.addAll(DatePickerDemo.class.getResource("/css/jfoenix-fonts.css").toExternalForm(),
        		DatePickerDemo.class.getResource("/css/jfoenix-design.css").toExternalForm());
