...
public class PropertyUtilsBean {
    ...
    private WeakFastHashMap<Class<?>, HashMap> mappedDescriptorsCache = null;
    ...
    public PropertyUtilsBean() {
        ...
        mappedDescriptorsCache = new WeakFastHashMap<Class<?>, HashMap>();
     ...
     */
    @Deprecated
    public HashMap getMappedPropertyDescriptors(Class<?> beanClass) {
     ...
     */
    @Deprecated
    public HashMap getMappedPropertyDescriptors(Object bean) {
