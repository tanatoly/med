 ...
 * @version $Id: ConfigurationUtils.java 1624601 2014-09-12 18:04:36Z oheger $
 */
public final class ConfigurationUtils
{
    ...
    public static Synchronizer cloneSynchronizer(Synchronizer sync)
    {
        ...
        {
        	System.out.println("Cannot create new instance of " + sync.getClass());
        }
            ...
            throws ClassNotFoundException
    {
        ...
        {
            System.out.println("Could not load class " + clsName
                    + " using CCL. Falling back to default CL.- " + cnfex.getMessage());
        }
