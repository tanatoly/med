...
public class TimeSection implements Comparable<TimeSection> {
    ...
    public TimeSection(final String JSON_STRING) {
        ...
        _start             = LocalTime.parse(LocalTime.now().toString());
        _stop              = LocalTime.parse(LocalTime.now().toString());
        _text              = "".toString();
        _color             = Color.web("#00000000");
        _highlightColor    = Color.web("#00000000");
        _textColor         = Color.web("#00000000");
        _active            = Boolean.parseBoolean("false");
        _icon              = null;
